...
for root,_,mask_paths in os.walk("gtFine_trainvaltest/gtFine"):
    for mask_path in mask_paths:
        if mask_path[-9:] == "color.png":
            ...
            base_masks.append(misc.imread("gtFine_trainvaltest/gtFine/" + subfolder + "/" + image_id+"_gtFine_color.png"))
            base_images.append(misc.imread("leftImg8bit_trainvaltest/leftImg8bit/" + subfolder + "/" + image_id + "_leftImg8bit.png"))
